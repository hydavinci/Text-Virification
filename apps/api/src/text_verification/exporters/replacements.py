...
class ReplacementPlanner:
    def build(
        ...
        for issue in issues_with_decisions:
            ...
            if decision is None or decision.action == DecisionAction.IGNORED:
                continue
            ...
            replacement_value = _resolve_replacement_value(issue)
...
def _resolve_replacement_value(issue: Issue) -> str | None:
    decision = issue.decision
    if decision is None:
        return None
